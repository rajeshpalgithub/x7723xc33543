...
abstract class REST_Controller extends CI_Controller {
...

    {
		...
		header("Access-Control-Allow-Headers: API-KEY, Origin, X-Requested-With, Content-Type, Accept,session, Access-Control-Request-Method,auth-token");
		header("Access-Control-Allow-Methods: GET, POST, OPTIONS, PUT, DELETE, HEAD, VIEW");
		header("Access-Control-Expose-Headers: Session");
		header("Session:".$this->session->session_id);
...

    {
        ...
        $isInserted = $this->rest->db
            ...
            ->insert(
                ...
                'time' => date("Y-m-d H:i:s"), // Used to be: function_exists('now') ? now() : time()
